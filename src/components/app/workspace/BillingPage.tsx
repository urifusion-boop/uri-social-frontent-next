            ...
            >
              ...
              <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #edecea', padding: 18 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  ...
                  <div>
                    <Tooltip title="The total number of content credits included in your current plan each billing cycle. Each credit generates one full set of platform posts." arrow placement="top">
              ...
              <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #edecea', padding: 18 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  ...
                  <div>
                    <Tooltip title="Credits consumed so far this billing cycle. Each content generation uses one credit." arrow placement="top">
                      <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 11, color: '#999', fontWeight: 600, cursor: 'help' }}>
                        CREDITS USED
                        <svg width={11} height={11} viewBox="0 0 24 24" fill="none" stroke="#ccc" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>
                      </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  ...
                  <div>
                    <Tooltip title="Credits still available this cycle. When this reaches zero, content generation is paused until your plan renews or you top up." arrow placement="top">
                      <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 11, color: '#999', fontWeight: 600, cursor: 'help' }}>
                        REMAINING
                        <svg width={11} height={11} viewBox="0 0 24 24" fill="none" stroke="#ccc" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>
                      </div>
