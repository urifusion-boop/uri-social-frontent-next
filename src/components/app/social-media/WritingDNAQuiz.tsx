...
const QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'C', text: '"There\'s this thing that happens when you finally figure out what works, and honestly, it changes everything."' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'D', text: 'I use jargon deliberately, then translate it to plain language. Shows I know the space without gatekeeping.' },
    ],
  ...
  },
  {
    ...
    options: [
      { value: 'A', text: '"I\'ve spent the last three years building this from nothing, and every time I think I\'ve figured it out, the market shifts. But that\'s the game, isn\'t it?"' },
      { value: 'B', text: '"Revenue up 40%. Churn down to 3%. Team of 12. Next target: 1,000 customers by December."' },
      { value: 'C', text: '"I don\'t have all the answers. But I\'ve made enough mistakes to know what doesn\'t work. And that\'s genuinely more useful."' },
      { value: 'D', text: '"Everyone\'s following the same playbook and getting mediocre results. We did something different. Here\'s what."' },
    ],
    ...
    >
      ...
      >
        <div style={{ width: '100%', maxWidth: '560px' }}>
          ...
          {step === 15 && (
            <div>
              <p style={{ fontSize: '12px', fontWeight: '600', color: URI_PINK, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>
                Identity & Positioning · 16 / 16
              </p>
              <h2 style={{ fontSize: '22px', fontWeight: '700', color: '#111', marginBottom: '28px', lineHeight: '1.35' }}>
          ...
          {step === 16 && (
            <div>
              ...
              >
                ...
                <div>
                  <p style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: URI_PINK }}>Bonus: The most powerful signal</p>
                  <p style={{ margin: '4px 0 0', fontSize: '13px', color: '#6b7280', lineHeight: '1.5' }}>
                    Paste a paragraph you&apos;ve written that sounds like you. Real writing beats quiz answers every time.
                    This is optional but it makes Jane&apos;s voice match dramatically more accurate.
                  </p>
                </div>
              </div>
