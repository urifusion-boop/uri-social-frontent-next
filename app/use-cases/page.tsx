          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 rounded-lg border-3 border-foreground" style={{ backgroundColor: s.bg }}>
                  ...
                  <ul className="space-y-3">
                    {s.challenges.map((c, j) => (
                      <li key={j} className="flex items-start gap-2">
                        <span className="font-black text-sm mt-0.5" style={{ color: 'hsl(0, 84%, 60%)' }}>
                          ✕
                        </span>
                ...
                >
                  ...
                  <ul className="space-y-3">
                    {s.solutions.map((sol, j) => (
                      <li key={j} className="flex items-start gap-2">
                        <span className="font-black text-sm mt-0.5" style={{ color: 'hsl(145, 65%, 45%)' }}>
                          ✓
                        </span>
